# 🍓 Grab Fruits! – UX-Driven Browser Game
...
- Created a [Game Design Document (GDD)](./game-design-document.md) before development to clarify user flow and logic
...
🔗 [Game Design Document (GDD)](./game-design-document.md)
